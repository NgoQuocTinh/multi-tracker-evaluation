...
OUTPUT_FILE = 'results_1/results_bytetrack.txt'
...
def run_ultralytics_bytetrack():
    """Run ByteTrack using Ultralytics and return number of frames processed."""
...
if __name__ == "__main__":
    ...
    total_frames = run_ultralytics_bytetrack()
    end_time = time.time()
    ...
    with open(fps_file, "a") as f:
        f.write(f"ByteTrack | time: {elapsed:.2f}s | FPS: {fps:.2f} | Frames: {total_frames}\n")

    print(f"ByteTrack tracking completed in {elapsed:.2f}s, FPS: {fps:.2f}")
